...
class InvoiceForm extends Component{
    constructor(props){
        ...
        this.tableData = [
            {"id": 2, "name": "Pressure Cooker", "stock": 20, "price": "238.00"},
            {"id": 2, "name": "Induction Cooktop", "stock": 20, "price": "980.00"},
            {"id": 3, "name": "Kettle", "stock": 20, "price": "305.00"},
            {"id": 4, "name": "Dust Broom", "stock": 20, "price": "139.00"},
        ]

        this.invoiceColumnList = ["ID", "Name", "Quantity", "Price", "Sub total"];
        this.invoiceTableData = [
            {"id": 1, "name": "Pressure Cooker.", "quantity": 1, "price": "238.00", "subtotal": 2000},
            {"id": 2, "name": "Induction Cooktop", "quantity": 2, "price": "980.00", "subtotal": 2000},
            {"id": 3, "name": "Kettle", "quantity": 1, "price": "305.00", "subtotal": 2000},
            {"id": 4, "name": "Dust Broom", "quantity": 4, "price": "139.00", "subtotal": 2000},
        ]
    }
