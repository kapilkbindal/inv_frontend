...
import PurchaseView from "../../../components/customer/PurchaseView";
    ...
    render(){
        return (
            ...
            <Switch>
                ...
                <Route exact path={`${this.props.match.path}/purchase/list`} component={PurchaseList}/>
                <Route exact path={`${this.props.match.path}/purchase/view/:purchaseId`} component={PurchaseView}/>
                <Route exact path={`${this.props.match.path}/purchase/create`} component={PurchaseForm}/>
            </Switch>
